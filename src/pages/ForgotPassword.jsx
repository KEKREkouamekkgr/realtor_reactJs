...
export default function ForgotPassword() {
  ...
  async function onSubmit(e){
    ...
    try{
      ...
      toast.success('L\'email a été envoyé!');
    }catch(error){
      toast.error('N\'a pas pu envoyé une réinitialisation de mot de passe');
    }
  }
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className="w-full md:w-[65%] lg:w-[40%] lg:ml-20">
          ...
          <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
            ...
            <p className=''>
              <Link to="/sign-in" className='text-blue-600 hover:text-blue-800 transition duration-300 ease-in-out ml-1'>Se Connecter</Link>
            </p>
          </div>
          <button type="submit" className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-800 transition duration-300 ease-in-out hover:shadow-lg active:bg-blue-800'>Réinitialiser</button>
